...
const projects = [
    {
        ...
        desc: "Sistem Chatbot WhatsApp AI berbasis Generative AI (RAG & Gemini) terintegrasi WhatsApp Business API untuk pelayanan publik Kementerian.",
    ...
    },
    {
        ...
        category: "HealthTech",
        desc: "Vendor SIMRS terintegrasi hulu-hilir: Pendaftaran Online, Rekam Medis Elektronik (RME), hingga integrasi Klaim BPJS Kesehatan.",
        tech: ["PostgreSQL", "BPJS API"],
