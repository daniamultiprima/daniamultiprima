...
export default function Hero() {
  return (
    <section className="relative w-full min-h-[100svh] flex flex-col justify-center overflow-hidden bg-[#020617]">
      ...
      {/* --- BACKGROUND FX (CSS GRID MANUAL + ORBS) --- */}
      <div className="absolute inset-0 w-full h-full overflow-hidden pointer-events-none">
        {/* CSS Grid Pattern: Tanpa download gambar, langsung coding */}
        <div 
        ...
        {/* Gradient Orbs - Mobile: Ukuran disesuaikan biar gk berat */}
      ...
      >
        ...
        <motion.p 
          variants={fadeInUp}
          className="text-base sm:text-lg md:text-xl text-gray-400 max-w-2xl mx-auto mb-8 md:mb-12 leading-relaxed px-2"
        >
          Kami membantu perusahaan Anda membangun infrastruktur digital masa depan dengan integrasi <span className="text-white font-semibold">Kecerdasan Buatan</span> yang presisi dan skalabel.
        </motion.p>
      ...
      {/* --- FOOTER STATS (Responsive Bar) --- */}
      {/* Di Desktop: Absolute Bottom. Di Mobile: Relative (biar ngalir ke bawah) */}
      <motion.div 
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
