  ...
  return (
    <section className="relative w-full min-h-[100svh] flex flex-col justify-center overflow-hidden bg-[#020617]">
      ...
      >
        ...
        >
          PT. Dania Multi Prima adalah <strong className="text-white font-semibold">Software House di Medan</strong> yang melayani jasa pembuatan Website, Aplikasi Android/iOS, dan Sistem Informasi Pemerintahan (SPBE). Kami membantu transformasi digital bisnis dan instansi di <strong className="text-white font-semibold">Sumatera Utara</strong> dan seluruh Indonesia.
        </motion.p>
        ...
        <div className="max-w-7xl mx-auto px-6 py-6 md:py-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-y-8 gap-x-4 md:gap-8 opacity-80 md:opacity-60 hover:opacity-100 transition-opacity duration-300">
            <div className="flex flex-col md:flex-row items-center md:justify-center gap-2 md:gap-3 text-center md:text-left">
              ...
              <span className="text-white font-bold text-xs md:text-sm tracking-widest uppercase">AI & IoT Ready</span>
            </div>
            <div className="flex flex-col md:flex-row items-center md:justify-center gap-2 md:gap-3 text-center md:text-left">
              <ShieldCheck className="text-blue-500 w-6 h-6" />
              <span className="text-white font-bold text-xs md:text-sm tracking-widest uppercase">Cyber Security</span>
            </div>
            <div className="flex flex-col md:flex-row items-center md:justify-center gap-2 md:gap-3 text-center md:text-left">
              <Globe className="text-blue-500 w-6 h-6" />
              <span className="text-white font-bold text-xs md:text-sm tracking-widest uppercase">Layanan Nasional</span>
            </div>
             <div className="flex flex-col md:flex-row items-center md:justify-center gap-2 md:gap-3 border-none md:border-l md:border-white/10 md:pl-8">
              <span className="text-white font-black text-xl md:text-2xl">35+</span>
              <span className="text-gray-400 text-[10px] md:text-xs leading-tight text-center md:text-left uppercase font-bold tracking-wider">Proyek <br className="hidden md:block"/>Sukses</span>
            </div>
          </div>
        </div>
      </motion.div>
