    ...
    <section className="relative w-full py-24 bg-[#020617] overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          {/* TITLE UPDATE: MATCHING HERO STYLE */}
          <motion.h2
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
          ...
          >
            ...
            {/* Ganti Gradient dengan Solid Blue + Drop Shadow Glow */}
          ...
          >
            Mitra teknologi strategis untuk mengakselerasi pertumbuhan bisnis
            dan modernisasi instansi Anda di era digital.
          </motion.p>
        </div>
