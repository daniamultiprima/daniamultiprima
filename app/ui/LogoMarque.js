...
const partners = [
  ...
  {
    name: "AJ ThinkLab",
    logo: "/images/clients/ajthinklab.svg",
    type: "EdTech",
  },
  {
    name: "Pemko Tanjung Balai",
    logo: "/images/clients/tanjung_balai.svg",
    type: "Government",
  },
  {
  ...
  { name: "Pemkab Agam", logo: "/images/clients/agam.svg", type: "Government" },
  {
    ...
    logo: "/images/clients/usu.svg",
    type: "University",
  },
  {
    name: "RSUD Drs. H. Amri Tambunan",
    logo: "/images/clients/tambunan.svg",
    type: "Hospital",
  },
  {
    name: "DPRD Deli Serdang",
    logo: "/images/clients/deliserdang.svg",
    type: "Government",
  },
  {
    name: "PT. Dat Daramenta Sejahtera",
    logo: "/images/clients/dds.svg",
    type: "Corporate",
  },
  {
    name: "Politeknik Penerbangan",
    logo: "/images/clients/poltekbang.svg",
    type: "Education",
  },
  {
    name: "Pemkab Serdang Bedagai",
    logo: "/images/clients/sergai.svg",
    type: "Government",
  },
  {
    name: "Pemko Binjai",
    logo: "/images/clients/binjai.svg",
    type: "Government",
  },
  {
    name: "RS Sri Pamela",
    logo: "/images/clients/sripamela.svg",
    type: "Hospital",
  },
  {
    name: "Kian & Kei Cafe",
    logo: "/images/clients/kian.svg",
    type: "F&B Business",
  },
  {
    name: "Amberjaini",
    logo: "/images/clients/amberjaini.svg",
    type: "Retail",
  },
  {
    name: "Gudang Sayur Kamtibmas",
    logo: "/images/clients/kamtibmas.svg",
    type: "Logistics",
  },
  {
    name: "Politeknik Negeri Medan",
    logo: "/images/clients/polmed.svg",
    type: "Education",
  },
  {
    name: "Pemkab Deli Serdang",
    logo: "/images/clients/deliserdang.svg",
    type: "Government",
  },
  {
  ...
  {
    name: "Darussalam",
    logo: "/images/clients/darussalam.svg",
    type: "School",
  },
];
  ...
  return (
    <section className="relative w-full py-20 md:py-28 bg-[#050505] overflow-hidden flex flex-col items-center justify-center">
      ...
      <div className="relative z-10 text-center mb-12 md:mb-20 px-6 max-w-4xl mx-auto">
        ...
        {/* TITLE (Updated to match Hero style) */}
        ...
        <p className="text-sm md:text-xl text-gray-400 max-w-2xl mx-auto leading-relaxed">
          Menjadi mitra teknologi andalan bagi{" "}
          <strong className="text-white font-semibold">
            Instansi Pemerintah (BUMN/Dinas)
          </strong>{" "}
          dan{" "}
          <strong className="text-white font-semibold">
            Perusahaan Swasta
    ...
    <div className="group relative w-[140px] h-[70px] md:w-[220px] md:h-[130px] flex-shrink-0">
      <div className="relative w-full h-full bg-white/[0.03] border border-white/[0.05] rounded-xl flex items-center justify-center transition-all duration-500 hover:bg-white/[0.08] hover:border-white/20 hover:shadow-lg hover:shadow-blue-500/10 backdrop-blur-sm overflow-hidden">
        <div className="relative w-24 h-12 md:w-44 md:h-24 transition-transform duration-500 group-hover:scale-110">
          <Image
            src={logoSrc}
            alt={`Logo ${name} - Partner Dania Multi Prima`}
            fill
