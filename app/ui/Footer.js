...
export default function Footer() {
  ...
  // Link Navigasi Sesuai Page yang Sudah Dibuat
  const companyLinks = [
    { name: 'Home', href: '/' },
    ...
    <footer className="relative bg-[#020617] border-t border-white/10 pt-20 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-8 mb-20 p-10 md:p-16 rounded-[2.5rem] bg-gradient-to-r from-blue-900/20 to-[#0B1120] border border-white/5 overflow-hidden relative group">
          ...
          <div className="relative z-10 text-center md:text-left">
            <h2 className="text-3xl md:text-5xl font-black text-white tracking-tight mb-4">
              Ready to <span className="text-blue-500">Scale Up?</span>
            </h2>
            <p className="text-gray-400 text-lg max-w-xl">
              Jangan biarkan teknologi membatasi visi Anda. Konsultasikan kebutuhan IT & AI perusahaan Anda bersama kami hari ini.
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 pb-20 border-b border-white/5">
          ...
          <div className="lg:col-span-5 space-y-8">
            ...
            <div className="flex flex-col">
                ...
                <div className="flex items-center gap-2 mt-2">
                  ...
                  <span className="text-gray-400 text-[10px] md:text-[11px] font-bold tracking-[0.35em] uppercase">
                    Multi Prima
                  </span>
                </div>
            </div>
            ...
            <p className="text-gray-400 text-sm leading-relaxed max-w-sm">
              Mitra transformasi digital terpercaya. Menggabungkan inovasi AI, keamanan siber, dan infrastruktur IT untuk masa depan bisnis Indonesia.
            </p>

            {/* Social Icons */}
            <div className="flex gap-4">
              {[Instagram, Linkedin, Facebook].map((Icon, i) => (
                <a key={i} href="#" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center text-gray-400 hover:bg-blue-600 hover:text-white transition-all border border-white/5 hover:border-blue-500">
                  <Icon size={18} />
                </a>
              ))}
            </div>
          ...
          {/* KOLOM 2: NAVIGATION (Lebar: 3 Kolom) - Menggantikan kolom Solutions yg dihapus */}
          <div className="lg:col-span-3 lg:col-start-6 space-y-8">
            <h4 className="text-white font-bold text-sm tracking-widest uppercase border-b border-white/10 pb-4 w-fit">
                Explore
            </h4>
          ...
          {/* KOLOM 3: CONTACT INFO (Lebar: 4 Kolom) */}
