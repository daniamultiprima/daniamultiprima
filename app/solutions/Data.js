      ...
      <div className="max-w-7xl mx-auto px-6 pt-32 pb-20 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-20">
          ...
          >
            ...
            {/* SEO TAG */}
            <h2 className="uppercase font-bold tracking-widest text-xs">SOLUSI IT BERBASIS INDUSTRI</h2>
          </motion.div>
          ...
          >
            Kami memahami DNA industri Anda. Dari <strong className="text-white">Smart City Pemerintahan</strong>, <strong className="text-white">SIMRS Rumah Sakit</strong>, hingga <strong className="text-white">Sistem Kampus Digital</strong>, kami menciptakan solusi yang menyelesaikan masalah nyata.
          </motion.p>
        </div>
    ...
    >
      ...
      <div className="relative z-10 flex items-start justify-between mb-8">
        <div>
           ...
           <h3 className="text-xs font-bold text-gray-500 uppercase tracking-widest mb-2">{data.title} Solutions</h3>
           <div className="text-2xl md:text-3xl font-bold text-white leading-tight">{data.subtitle}</div>
        </div>
