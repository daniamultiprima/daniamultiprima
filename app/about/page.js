      ...
      <section className="relative pt-40 pb-20 px-6 border-b border-white/5">
        <div className="max-w-7xl mx-auto">
           ...
           <motion.div 
             ...
             className="mb-8"
           >
              <span className="text-blue-500 font-bold tracking-[0.2em] text-sm uppercase block mb-4">
                Since 2017 — North Sumatra
              </span>
           ...
           >
              <p className="text-xl text-gray-400 leading-relaxed">
                PT. Dania Multi Prima adalah mitra strategis transformasi digital. Kami menggabungkan rekayasa perangkat lunak, keamanan siber, dan kecerdasan buatan untuk membangun infrastruktur masa depan.
              </p>
      ...
      <section className="py-24 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 auto-rows-[minmax(300px,auto)]">
            ...
            {/* 1. VISION CARD (Big & Impactful) - Span 2 Kolom */}
               ...
               <div className="flex flex-col justify-between h-full">
                  ...
                  <div>
                     <h3 className="text-3xl md:text-4xl font-bold leading-tight mb-6 text-white">
                        Menjadi mitra teknologi terpercaya yang mendorong transformasi digital berkelanjutan melalui inovasi dan solusi cerdas.
                     </h3>
                  </div>
               </div>
            </BentoCard>

            {/* 2. STATS CARD (Years) - Span 1 Kolom */}
            ...
            {/* 3. MISSION CARD (Clean List) - Span 1 Kolom */}
            {/* PERBAIKAN: Hapus row-span-2 dan kurangi spacing agar tinggi seimbang */}
            <BentoCard className="bg-[#0B1120] flex flex-col justify-between">
               <div className="flex flex-col h-full">
                  ...
                  <div className="mt-6 space-y-6 flex-grow">
                     <MissionItem text="Solusi teknologi terintegrasi (Software, AI, IoT) yang disesuaikan." cite="83" />
                     <MissionItem text="Mengutamakan keamanan siber & infrastruktur stabil." cite="84" />
                     <MissionItem text="Inovasi berkelanjutan mengikuti tren global." cite="85" />
                     <MissionItem text="Kemitraan jangka panjang yang transparan." cite="86" />
                  </div>
               </div>
            </BentoCard>

            {/* 4. ABOUT / HISTORY (Story) - Span 2 Kolom */}
               ...
               <div className="relative z-10 flex flex-col h-full justify-between">
                  <div>
                    ...
                    <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-12 text-gray-400 text-lg leading-relaxed">
                        <p>
                            Selama lebih dari delapan tahun, kami telah dipercaya oleh berbagai sektor industri untuk mengembangkan solusi teknologi yang andal.
                        </p>
                        <p>
                            Portofolio kami mencakup pengembangan software, aplikasi mobile, web, AI, IoT, hingga pengamanan sistem melalui pendekatan siber modern.
                        </p>
                    </div>
                  </div>
                  
                  {/* Stats Row Kecil di Bawah */}
                  <div className="mt-12 flex gap-12 border-t border-white/10 pt-8">
                     ...
                     <div>
                        ...
                        <div className="text-xs text-gray-500 uppercase tracking-widest mt-1">Services</div>
                     </div>
                  </div>
               </div>
            </BentoCard>

            {/* 5. CORE VALUES (Horizontal) - Span 3 Kolom (Full Width) */}
            <div className="md:col-span-3 grid grid-cols-1 md:grid-cols-3 gap-8 mt-4">
               <ValueCard 
                  title="Full Customization" 
                  desc="Kami tidak percaya 'satu solusi untuk semua'. Setiap sistem dirancang unik."
                  icon={Cpu}
               />
               <ValueCard 
                  title="Security First" 
                  desc="Keamanan siber adalah prioritas utama dalam setiap pengembangan sistem."
                  icon={Shield}
               />
               <ValueCard 
                  title="Integrated System" 
                  desc="Layanan satu atap: Software, Mobile App, AI, hingga Infrastruktur."
                  icon={Globe2}
               />
            </div>
      ...
      <section className="py-24 border-t border-white/5 bg-[#050505]">
         <div className="max-w-4xl mx-auto text-center px-6">
            ...
            <p className="text-xl text-gray-400 mb-10">
               Diskusikan visi digital Anda bersama tim ahli kami.
            </p>
            <a 
               href="/contact"
