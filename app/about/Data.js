        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-400 leading-relaxed">
              <strong className="text-white">PT. Dania Multi Prima</strong>{" "}
              adalah perusahaan{" "}
              <strong className="text-white">Konsultan IT</strong> dan{" "}
              <strong className="text-white">Software House</strong>{" "}
              profesional. Kami mengintegrasikan rekayasa perangkat lunak,{" "}
              <strong className="text-white">Keamanan Siber</strong>, dan{" "}
              <strong className="text-white">Solusi AI</strong> untuk membangun
              ...
              <div className="flex flex-col justify-between h-full">
                ...
                <div>
                  <h3 className="text-3xl md:text-4xl font-bold leading-tight mb-6 text-white">
                    Menjadi mitra teknologi terpercaya yang mendorong
                    transformasi digital berkelanjutan melalui inovasi dan
                    solusi cerdas bagi Pemerintah dan Swasta.
                  </h3>
                </div>
              </div>
            </BentoCard>
            ...
            <BentoCard className="bg-[#0B1120] flex flex-col justify-between">
              <div className="flex flex-col h-full">
                ...
                <div className="mt-6 space-y-6 flex-grow">
                  <MissionItem
                    text="Jasa Pembuatan Aplikasi Custom (Web & Mobile)."
                    cite="83"
                  />
                  <MissionItem
                    text="Pengembangan Sistem Smart City & SIMRS."
                    cite="84"
                  />
                  <MissionItem
                    text="Implementasi Keamanan Siber & AI."
                    cite="85"
                  />
                  <MissionItem
                    text="Layanan Maintenance & IT Support 24/7."
                    cite="86"
                  />
                </div>
              </div>
                ...
                <div>
                  ...
                  <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-12 text-gray-400 text-lg leading-relaxed">
                    <p>
                      ...
                      , kami telah menangani 50+ proyek strategis mulai dari{" "}
                      <strong className="text-white">
                        Sistem Pemerintahan (SPBE)
                      </strong>
                      , Rumah Sakit, hingga Perusahaan Multinasional.
                    </p>
                    <p>
                      Kami menyediakan layanan *End-to-End*: mulai dari
                      konsultasi, perancangan sistem,{" "}
                      <strong className="text-white">
                        Pembuatan Aplikasi Android/iOS
                      </strong>
                      , hingga integrasi server dan cloud yang aman.
                    </p>
                  </div>
                </div>
      ...
      <section className="py-24 border-t border-white/5 bg-[#050505]">
        <div className="max-w-4xl mx-auto text-center px-6">
          ...
          <p className="text-xl text-gray-400 mb-10">
            Diskusikan visi digital Anda bersama tim ahli Dania Multi Prima
            sekarang juga.
          </p>
          <a
            href="/contacts"
